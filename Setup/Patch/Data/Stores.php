...
namespace Ad\Stores\Setup\Patch\Data;
...
class Stores implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $website->load('usa_website_3');
        if (!$website->getId()) {
            $website->setCode('usa_website_3');
        ...
        if ($website->getId()) {
            ...
            $group->setCode("usa_store_group_3");
